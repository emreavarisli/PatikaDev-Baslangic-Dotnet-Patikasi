...
namespace Todo
{
    public class Board
    {
        ...
        public Board()
        {
            ...
            {
                new TeamMember(10,"Emre Avarisli"),
                new TeamMember(20,"Hasan Avarisli"),
                new TeamMember(30,"Ahmet Şahin"),
                new TeamMember(40,"Eren Erdoğan"),
                new TeamMember(50,"Sertaç Erdoğan"),
                new TeamMember(60,"Ümit Akyüz")
